# nvim-treesitter-queries-vento

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vento/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vento/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vento**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-vento",
...
- [ ] Changes are scoped to `vento` — do not include files for other languages
